...
@section('content')
    ...
    <div class="container" style="margin-top: 20px">
        ...
        <form method="post" action="{{route('dealer.postAdd')}}">
            @csrf
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Mã Đại Lý</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('code') is-invalid  @enderror"  placeholder="Mã đại lý" name="code">
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control @error('manager') is-invalid  @enderror"  placeholder="tên người quản lý" name="manager">
                </div>
            </div>
